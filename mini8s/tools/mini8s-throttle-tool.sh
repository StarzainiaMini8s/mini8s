...
echo "Welcome to the Mini8s v0.3.99 Throttling Tool!"
...
echo ""
echo "⚠️ WARNING: This throttling tool is specifically designed for maximizing runtime of Mini8s v0.3.99 on battery powered devices, running this tool will THROTTLE YOUR CPU TO IT'S LOWEST POSSIBLE FREQUENCY!!! If you are aware of what this tool does and would like proceed, enter \"Y\", if otherwise, enter \"N\"."
echo ""
read -p "[Y/N]: " choice
